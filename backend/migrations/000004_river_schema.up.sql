-- River job queue schema for PostgreSQL (pgx/v5 driver).
-- Source: github.com/riverqueue/river/riverdriver/riverpgxv5 v0.44.1 bundled migrations 001-007 (up),
-- split: sections 001-004 in this file, 005-007 in 000005 (enum ADD VALUE must commit before use).
